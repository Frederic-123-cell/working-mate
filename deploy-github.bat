...
echo [5/6] Committing...
"%GIT%" -c user.email="%EMAIL%" -c user.name="%USERNAME%" commit -m "Website: credits pricing (1000/2000/5000 credit packs), 3000 welcome credits, subscription-gated tiers, region.js zh mappings, 9-language updates" 2>&1
echo.
